...
submit.onclick = (e) => {
  ...
  // removeflexbasis();
  // let flexbasis1 = document.getElementById("flexbasis1");
  // let fb1 = flexbasis1.value;
  // flexbasis1.classList.add("basis-" + fb1);

  // let flexbasis2 = document.getElementById("flexbasis2");
  // let fb2 = flexbasis2.value;
  // flexbasis2.classList.add("basis-" + fb2);

  // let flexbasis3 = document.getElementById("flexbasis3");
  // let fb3 = flexbasis1.value;
  // flexbasis3.classList.add("basis-" + fb3);

  // let flexbasis4 = document.getElementById("flexbasis4");
  // let fb4 = flexbasis4.value;
  // flexbasis1.classList.add("basis-" + fb4);
...
//flexbasis
// function removeflexbasis() {
//     let flexbasis1 = document.getElementById("flexbasis1");
//     let flexbasis2 = document.getElementById("flexbasis2");
//     let flexbasis3 = document.getElementById("flexbasis3");
//     let flexbasis4 = document.getElementById("flexbasis4");
//     for (let i = 0; i < 13; i++){
//         flexbasis1.classList.remove("basis-" + i);
//     }
//     for (let i = 0; i < 13; i++){
//         flexbasis2.classList.remove("basis-" + i);
//     }
//     for (let i = 0; i < 13; i++){
//         flexbasis3.classList.remove("basis-" + i);
//     }
//     for (let i = 0; i < 13; i++){
//         flexbasis4.classList.remove("basis-" + i);
//     }
// }
